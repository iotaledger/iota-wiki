module.exports = {
  ...
  collaboration:
    'Working together and cooperating towards shared goals or outcomes.',
  collateral:
  ...
  'deficit round robin (DRR) algorithm':
    'An algorithm used in the IOTA2.0 node"s scheduler to dequeue and prioritize blocks for gossiping.',
  delegation:
  ...
  'distributed ledger technology (DLT)':
    'A type of technology that enables the secure and decentralized storage and sharing of information across a network and allows unaligned parties to maintain a common state.',
  'double spend': 'Two transactions that attempt to consume the same UTXO.',
  'double-spending':
  ...
  'neighbor selection module': 'See "Autopeering"',
  neighbors:
  ...
  'pre-Acceptance': 'see Confirmation',
  'pre-Acceptance Flag':
  ...
  'pre-Confirmation': 'see Confirmation',
  'private tangle':
  ...
  'service provider':
    'An entity or organization that offers services to users or clients.',
  sharding:
