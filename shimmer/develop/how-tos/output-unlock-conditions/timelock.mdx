...
description: 'Learn about locking funds based on time using the Timelock Unlock Condition in Stardust. Understand how to create a timelocked output and how to move funds once the timelock expires.'
keywords:
...
With Stardust, you can lock funds away based on time. When an output has a [Timelock Unlock Condition](https://wiki.iota.org/shimmer/tips/tips/TIP-0018#timelock-unlock-condition)
