...
- Using different `accounts` may be useful to split addresses/keys into some independent spaces, and it is up to
  ...
  planning on using many multiple accounts then you may be interested in our
  [IOTA SDK](/iota-sdk/welcome/) that incorporates all business logic needed to efficiently manage
...
- [Create an Account](/iota-sdk/how-tos/accounts-and-addresses/create-account/)
- [List Accounts](/iota-sdk/how-tos/accounts-and-addresses/list-accounts/)
- [List Addresses](/iota-sdk/how-tos/accounts-and-addresses/list-addresses/)
- [Create an Address](/iota-sdk/how-tos/accounts-and-addresses/create-address/)
