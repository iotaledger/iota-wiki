...
- [Create an address](https://wiki.iota.org/shimmer/iota.js/how_tos/address/)
- [Create a addresses](https://wiki.iota.org/shimmer/iota.js/tutorials/value-transactions/generate-addresses/)
- [Create a public addresses](https://wiki.iota.org/shimmer/iota.js/tutorials/value-transactions/public-addresses/)
