...
<dl>
  ...
  <dt>
    <a href='#DomainLinkageValidator'>DomainLinkageValidator</a>
  </dt>
  <dd>
  ...
  <dd>
    <p>
      A type for decoding and validating <code>Credentials</code>.
    </p>
  </dd>
  <dt>
    <a href='#JwtPresentation'>JwtPresentation</a>
  </dt>
  <dd></dd>
  <dt>
  ...
  <dd>
    <p>
      Unique identifier of a [<code>VerificationMethod</code>].
    </p>
    <p>
...
<dl>
  ...
  <dd>
    <p>
      Verify a JWS signature secured with the <code>JwsAlgorithm::EdDSA</code>{' '}
      algorithm. Only the <code>EdCurve::Ed25519</code> variant is supported for
      now.
    </p>
    <p>
      This function is useful when one is building an <code>IJwsVerifier</code>{' '}
