...
See [What is Stardust?](https://wiki.iota.org/shimmer/develop/explanations/what-is-stardust/)
...
See the [backup and security guide](https://wiki.iota.org/shimmer/introduction/how_tos/backup_security/) for more
information.
