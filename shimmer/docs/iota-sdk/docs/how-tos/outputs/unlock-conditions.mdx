...
1. [`StorageDepositReturnUnlockCondition`](https://wiki.iota.org/next/iota-sdk/references/python/iota_sdk/types/unlock_condition.md#storagedepositreturnunlockcondition-objects).
...
2. [`TimelockUnlockCondition`](https://wiki.iota.org/next/iota-sdk/references/python/iota_sdk/types/unlock_condition.md#timelockunlockcondition-objects).
...
3. [`ExpirationUnlockCondition`](https://wiki.iota.org/next/iota-sdk/references/python/iota_sdk/types/unlock_condition.md#expirationunlockcondition-objects).
...
4. [`GovernorAddressUnlockCondition`](https://wiki.iota.org/next/iota-sdk/references/python/iota_sdk/types/unlock_condition.md#statecontrolleraddressunlockcondition-objects) and [`StateControllerAddressUnlockCondition`](https://wiki.iota.org/next/iota-sdk/references/python/iota_sdk/types/unlock_condition.md#governoraddressunlockcondition-objects).
...
6. [`ImmutableAliasAddressUnlockCondition`](https://wiki.iota.org/next/iota-sdk/references/python/iota_sdk/types/unlock_condition.md#immutablealiasaddressunlockcondition-objects).
