...
api:
  {
                ...
                'schema':
                  {
                    ...
                    'required':
                      ['index', 'timestamp', 'parents', 'previousMilestoneId'],
                  },
                'examples':
                  {
                    'default':
    ...
    'postman':
      {
        'name': 'Computes applied and confirmed merkle route hashes for a proposed milestone.',
        'description':
          {
            'content': 'Computes applied and confirmed merkle route hashes for a proposed milestone.',
            'type': 'text/plain',
          },
        'url':
          {
