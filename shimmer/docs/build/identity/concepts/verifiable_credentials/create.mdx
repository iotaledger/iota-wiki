...
import create_vc_ts from '!!raw-loader!/shimmer/external/identity.rs/0.7-alpha/bindings/wasm/examples/src/0_basic/5_create_vc.ts';
import create_vc_rs from '!!raw-loader!/shimmer/external/identity.rs/0.7-alpha/examples/0_basic/5_create_vc.rs';
