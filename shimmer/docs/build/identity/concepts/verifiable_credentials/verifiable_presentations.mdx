...
import create_vp_ts from '!!raw-loader!/shimmer/external/identity.rs/0.7-alpha/bindings/wasm/examples/src/0_basic/6_create_vp.ts';
import create_vp_rs from '!!raw-loader!/shimmer/external/identity.rs/0.7-alpha/examples/0_basic/6_create_vp.rs';
import CodeSnippet from '/src/common/components/CodeSnippetComponent';

A verifiable presentation is the recommended data format for sharing one or more [verifiable credentials](./../../../../learn/identity/overview.md).
