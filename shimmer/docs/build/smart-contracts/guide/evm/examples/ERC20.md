...
![Compile ERC20.sol](/img/ISC/evm/examples/compile.png)
...
![Deploy ERC20.sol](/img/ISC/evm/examples/deploy.png)

4. Your MetaMask browser extension will open automatically - press **confirm**.

![Confirm in MetaMask](/img/ISC/evm/examples/deploy-metamask.png)
...
![Copy contract address](/img/ISC/evm/examples/explorer-contract-address.png)

## 5. Have some Fun!

Now you should see your token in MetaMask. You can send them to your friends without any fees or gas costs.

![Copy contract address](/img/ISC/evm/examples/erc20-balance.png)
