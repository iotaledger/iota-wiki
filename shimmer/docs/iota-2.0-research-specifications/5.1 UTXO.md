...
- [2.3 Standard Payloads Layout](./2.3StandardPayloadsLayout#transaction-payload)
...
1. The <i>Transaction Essence</i> part contains: version, timestamp, nodeID of the [aMana](./5.3Mana) pledge, nodeID of the [cMana](./5.3Mana) pledge, inputs, outputs and an optional data payload.
...
The table describing the entirety of a <i>Transaction</i>'s serialized form is presented in the [Section 2.3 Standard Payloads Layout](./2.3StandardPayloadsLayout#2.3.5.2-transaction-payload).
...
The <i>Transaction Essence</i> of a <i>Transaction</i> carries a version, timestamp, nodeID of the [aMana](./5.3Mana) pledge, nodeID of the [cMana](./5.3Mana) pledge, inputs, outputs and an optional data payload.
...
If a transaction passes the semantic validation, its referenced UTXOs _shall_ be marked as spent and the corresponding new outputs _shall_ be booked/specified in the ledger. This process is described in [Section 5.2 - Ledger state](./5.2LedgerState).
