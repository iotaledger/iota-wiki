...
import revoke_vc_ts from '!!raw-loader!/shimmer/external/identity.rs/0.7-alpha/bindings/wasm/examples/src/0_basic/7_revoke_vc.ts';
import revoke_vc_rs from '!!raw-loader!/shimmer/external/identity.rs/0.7-alpha/examples/0_basic/7_revoke_vc.rs';
