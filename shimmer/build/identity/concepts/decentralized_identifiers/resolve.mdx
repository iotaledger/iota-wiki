...
import resolve_did_custom_rs from '!!raw-loader!/shimmer/external/identity.rs/0.7-alpha/examples/1_advanced/6_custom_resolution.rs';
import resolve_did_custom_js from '!!raw-loader!/shimmer/external/identity.rs/0.7-alpha/bindings/wasm/examples/src/1_advanced/5_custom_resolution.ts';
