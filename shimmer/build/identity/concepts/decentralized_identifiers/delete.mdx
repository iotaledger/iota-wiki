...
import deactivate_did_rs from '!!raw-loader!/shimmer/external/identity.rs/0.7-alpha/examples/0_basic/3_deactivate_did.rs';
import deactivate_did_js from '!!raw-loader!/shimmer/external/identity.rs/0.7-alpha/bindings/wasm/examples/src/0_basic/3_deactivate_did.ts';
import delete_did_rs from '!!raw-loader!/shimmer/external/identity.rs/0.7-alpha/examples/0_basic/4_delete_did.rs';
import delete_did_js from '!!raw-loader!/shimmer/external/identity.rs/0.7-alpha/bindings/wasm/examples/src/0_basic/4_delete_did.ts';
