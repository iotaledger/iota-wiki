...
by an AgentID.'
image: /img/ISC/tutorial/accounts.png
keywords:
...
[![Example situation. Two chains are deployed, with three smart contracts and one address.](/img/ISC/tutorial/accounts.png)](/img/ISC/tutorial/accounts.png)
