          ...
          items: [
            {
              ...
              items: [
                ...
                'identity/getting_started/create_and_publish',
                {
                  ...
                  label: 'Rust',
                  collapsed: true,
                  items: ['identity/getting_started/rust/getting_started'],
                },
                {
                  type: 'category',
                  label: 'WASM',
                  collapsed: true,
                  items: [
                    'identity/getting_started/wasm/getting_started',
                    'identity/getting_started/wasm/api_reference',
                  ],
                },
              ],
            },
            ...
            },
            {
              ...
              label: 'Tutorials',
              items: [
                'identity/tutorials/overview',
                'identity/tutorials/validate_university_degree',
              ],
            },
            {
              type: 'category',
