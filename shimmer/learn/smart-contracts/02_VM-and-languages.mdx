...
*   Introduction to ShimmerEVM Testnet
...
The [ShimmerEVM Testnet](https://shimmer.network/) is a recent development in the IOTA ecosystem. It is a permissionless, feeless, and fast Layer-1 Testnet that incorporates the Ethereum Virtual Machine (EVM) on Layer-2. ShimmerEVM Testnet allows developers to deploy and test smart contracts in a familiar environment, making it easier for those who are already accustomed to Ethereum development. You can find more information and related links on this [ShimmerEVM Testnet Launch Blog Post](https://blog.shimmer.network/shimmerevm-testnet-launch/).

Click the button below to add the ShimmerEVM Testnet Network the your [MetaMask](https://metamask.io/).
<AddToMetaMaskButton />
