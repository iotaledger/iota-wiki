...
Accounts are related to a specific [IOTA or Shimmer Layer 1 Network](./../../../get-started/ecosysten-overview/layer-1-landscape.md). You can create as many accounts as you want per seed, and then use those accounts to generate as many addresses as you want.
