...
```rust reference
https://github.com/iotaledger/wallet.rs/tree/production//examples/transfer.rs
```
...
```rust reference
https://github.com/iotaledger/wallet.rs/tree/production/examples/event.rs
```

## Logger

```rust reference
https://github.com/iotaledger/wallet.rs/tree/production/examples/logger.rs
```
