...
The `StorageTestSuite` can be used to test the basic functionality of storage implementations. See its documentation for more details.

:::note

This test suite is available in newer versions of the framework, but not yet in version 0.5.
