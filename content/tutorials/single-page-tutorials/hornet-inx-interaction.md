...
- The examples below show how to use simple requests and streaming requests
...
#### Prepare proto file
- Copy the `inx-proto` file from [here](https://github.com/iotaledger/inx/blob/develop/proto/inx.proto) into your folder
- The `inx-proto` file contains the definition of all available endpoints
- Below you will see a few example of both simple requests and streaming requests
...
### Execution Steps
Execute the created files one by one and check out the console output.
