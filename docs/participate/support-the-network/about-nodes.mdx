...
* Exposing  <GlossaryToolTip glossaryKey="API" /> for clients
...
## Exposing <GlossaryToolTip glossaryKey="API" />s for clients

Nodes come with two <GlossaryToolTip glossaryKey="API" />s:

* HTTP <GlossaryToolTip glossaryKey="API" />
* Events <GlossaryToolTip glossaryKey="API" />
### HTTP <GlossaryToolTip glossaryKey="API" />

The HTTP <GlossaryToolTip glossaryKey="API" />  allows clients to interact with the Tangle and ask nodes to do the following:
...
The Events <GlossaryToolTip glossaryKey="API" />  allows clients to poll nodes for new transactions and other events that happen on nodes.

This <GlossaryToolTip glossaryKey="API" />  is useful for building applications such as custodial wallets that need to monitor the Tangle for updates to the balances of certain addresses.
