...
The [recommended setup](../how_tos/using_docker.md) uses Docker to run HORNET together with some [INX](/develop/explanations/what-is-shimmer/nodes/about-nodes/) extensions secured behind a [Traefik](https://traefik.io) SSL reverse proxy.
