...
- `AccountManager` becomes
  [`Wallet`](file:///home/lucas/Documents/IOTA/iota-sdk/target/doc/iota_sdk/wallet/core/struct.Wallet.html).
...
```rust reference
https://github.com/iotaledger/iota-sdk/blob/2.0/sdk/examples/how_tos/accounts_and_addresses/create_mnemonic.rs#L10-L19
```
...
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/nodejs/examples/how_tos/accounts_and_addresses/create-mnemonic.ts#L4-L19
```
...
```python reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/python/examples/how_tos/accounts_and_addresses/create_mnemonic.py
```
...
```rust reference
https://github.com/iotaledger/iota-sdk/blob/2.0/sdk/examples/how_tos/accounts_and_addresses/create_account.rs#L13-L999
```
...
```typescript reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/nodejs/examples/how_tos/accounts_and_addresses/create-account.ts#L4-L66
```
...
```python reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/python/examples/how_tos/accounts_and_addresses/create_account.py
```
...
[`Wallet.get_account(accountId|alias)`](file:///home/lucas/Documents/IOTA/iota-sdk/target/doc/iota_sdk/wallet/core/struct.Wallet.html#method.get_account)
or get all accounts with
[`Wallet.get_accounts()`](file:///home/lucas/Documents/IOTA/iota-sdk/target/doc/iota_sdk/wallet/core/struct.Wallet.html#method.get_accounts).
...
```rust reference
https://github.com/iotaledger/iota-sdk/blob/2.0/sdk/examples/how_tos/accounts_and_addresses/create_address.rs#L14-L999
```
...
```typescript reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/nodejs/examples/how_tos/accounts_and_addresses/create-address.ts#L4-L39
```
...
```python reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/python/examples/how_tos/accounts_and_addresses/create_address.py
```
...
```rust reference
https://github.com/iotaledger/iota-sdk/blob/2.0/sdk/examples/how_tos/accounts_and_addresses/check_balance.rs#L14-L999
```
...
```typescript reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/nodejs/examples/how_tos/accounts_and_addresses/check-balance.ts#L4-L37
```
...
```python reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/python/examples/how_tos/accounts_and_addresses/check_balance.py
```
...
```rust reference
https://github.com/iotaledger/iota-sdk/blob/2.0/sdk/examples/wallet/events.rs#L12-L999
```
...
```typescript reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/nodejs/examples/exchange/4-listen-events.ts#L8-L60
```
...
```python reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/python/examples/exchange/4_listen_events.py#L6-L62
```
...
```rust reference
https://github.com/iotaledger/iota-sdk/blob/2.0/sdk/examples/how_tos/simple_transaction/simple_transaction.rs#L14-L999
```
...
```js reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/nodejs/examples/exchange/5-send-amount.ts#L8-L58
```
...
```python reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/python/examples/exchange/5_send_amount.py#L6-L38
```
