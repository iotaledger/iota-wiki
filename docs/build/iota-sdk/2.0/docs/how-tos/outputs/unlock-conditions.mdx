...
Outputs can have different [unlock conditions](/learn/protocols/stardust/core-concepts/output-unlock-conditions/).
This guide explains how to add them to an output.
...
```rust reference
https://github.com/iotaledger/iota-sdk/blob/2.0/sdk/examples/how_tos/outputs/unlock_conditions.rs#L54-L57
```
...
```rust reference
https://github.com/iotaledger/iota-sdk/blob/2.0/sdk/examples/how_tos/outputs/unlock_conditions.rs#L59-L62
```
...
```rust reference
https://github.com/iotaledger/iota-sdk/blob/2.0/sdk/examples/how_tos/outputs/unlock_conditions.rs#L64-L66
```

</div>

4. [`ImmutableAliasAddressUnlockCondition`](https://docs.rs/iota-sdk/latest/iota_sdk/types/block/output/unlock_condition/struct.ImmutableAliasAddressUnlockCondition.html).

<div className={'hide-code-block-extras'}>

```rust reference
https://github.com/iotaledger/iota-sdk/blob/2.0/sdk/examples/how_tos/outputs/unlock_conditions.rs#L68-L72
```
...
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/nodejs/examples/how_tos/outputs/unlock-conditions.ts#L52-L60
```
...
```typescript reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/nodejs/examples/how_tos/outputs/unlock-conditions.ts#L63-L68
```
...
```typescript reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/nodejs/examples/how_tos/outputs/unlock-conditions.ts#L71-L76
```

</div>

4. [`ImmutableAliasAccountUnlockCondition`](../../references/nodejs/classes/ImmutableAccountAddressUnlockCondition.md).

<div className={'hide-code-block-extras'}>

```typescript reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/nodejs/examples/how_tos/outputs/unlock-conditions.ts#L79-L84
```
...
```python reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/python/examples/how_tos/outputs/unlock_conditions.py#L36-L44
```
...
```python reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/python/examples/how_tos/outputs/unlock_conditions.py#L48-L53
```
...
```python reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/python/examples/how_tos/outputs/unlock_conditions.py#L57-L65
```

</div>

4. [`ImmutableAccountAddressUnlockCondition`](../../references/python/iota_sdk/types/unlock_condition.md#immutableaccountaddressunlockcondition-objects).

<div className={'hide-code-block-extras'}>

```python reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/python/examples/how_tos/outputs/unlock_conditions.py#L69-L77
```
...
```rust reference
https://github.com/iotaledger/iota-sdk/blob/2.0/sdk/examples/how_tos/outputs/unlock_conditions.rs
```
...
```typescript reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/nodejs/examples/how_tos/outputs/unlock-conditions.ts
```
...
```python reference
https://github.com/iotaledger/iota-sdk/blob/2.0/bindings/python/examples/how_tos/outputs/unlock_conditions.py
```
