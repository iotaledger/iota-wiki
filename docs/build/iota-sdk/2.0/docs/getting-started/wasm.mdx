...
new [`Wallet`](https://wiki.iota.org/iota-sdk/references/nodejs/classes/Wallet.md [`Account`](https://wiki.iota.org/iota-sdk/references/nodejs/classes/Account.md
that connects to the [Shimmer Testnet](https://api.testnet.shimmer.network) using the
[`MnemonicSecretManager`](https://wiki.iota.org/iota-sdk/references/nodejs/interfaces/MnemonicSecretManager.md
by calling
...
[IOTA Wiki](https://wiki.iota.org/shimmer/iota-sdk/references/nodejs/api_ref.md.