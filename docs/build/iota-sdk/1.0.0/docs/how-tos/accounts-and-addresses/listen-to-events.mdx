...
1. Instantiate a [`wallet`](../../references/python/iota_sdk/wallet.md).
...
3. Use the `wallet` instance to listen to events with the
   [`wallet.listen()`](../../references/python/iota_sdk/wallet.md#listen) function. You can listen for a specific
