...
An [NFT](/introduction/explanations/ledger/nft/) is a unique token on the ledger. Its owner
...
their [storage costs](/introduction/explanations/what_is_stardust/storage_deposit/) with
...
- A unspent [Basic Output](/tips/tips/TIP-0018/#basic-output) that holds enough funds for
  ...
  the [Testnet](/introduction/reference/networks/betanet/), you
...
the [IRC27 standard](/tips/tips/TIP-0027/) is used to assert that the asset is an image
