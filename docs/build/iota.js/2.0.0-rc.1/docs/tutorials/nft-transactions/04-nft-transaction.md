...
additional [storage deposit return](/introduction/explanations/what_is_stardust/unlock_conditions/#storage-deposit-return) [unlock condition](/introduction/explanations/what_is_stardust/unlock_conditions/)
to the NFT Output.
...
the [indexation plugin](/inx-indexer/welcome/) by NFT ID. You need to obtain the full
...
1. The [address](/introduction/explanations/what_is_stardust/unlock_conditions/#address)
   corresponding to the new owner of the NFT (for instance, the buyer of the NFT).
2. A [storage deposit unlock condition](/introduction/explanations/what_is_stardust/unlock_conditions/#storage-deposit-return)
