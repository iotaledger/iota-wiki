...
```ts reference
https://github.com/iotaledger/iota.js/tree/feat/stardust/packages/iota/examples/browser/index.html
```
...
finishes the _parent blocks_ are no longer valid. You can use [simple connection](simple.mdx) how-to that showcases the
