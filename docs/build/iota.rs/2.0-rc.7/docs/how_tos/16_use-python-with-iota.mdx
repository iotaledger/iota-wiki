...
To install the IOTA version you need to follow the [Install from source](/iota.rs/getting_started/python#install-from-source) guide.
...
Now you can continue the installation from [here](/iota.rs/getting_started/python#change-to-the-python-binding-directory).
