...
```java reference
https://github.com/iotaledger/iota.rs/blob/production/bindings/java/examples/java-app/src/main/java/org/iota/client/example/ExampleApp.java#L72-L82
```
...
[Chrysalis documentations](/chrysalis-docs/guides/developer#iota-15-address-anatom), but here are
