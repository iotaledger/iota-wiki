...
```js reference
https://github.com/iotaledger/iota.rs/tree/production/bindings/nodejs/examples/01_get_info.js
```
...
```js reference
https://github.com/iotaledger/iota.rs/tree/production/bindings/nodejs/examples/01b_get_info.js
```
