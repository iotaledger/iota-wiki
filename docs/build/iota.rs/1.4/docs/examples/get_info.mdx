...
[IOTA nodes](/introduction/explanations/node_software) that power IOTA network.

The library is designed to automatically choose a starting IOTA node based on the network type you would like to
participate in: [`devnet`](/introduction/reference/networks/devnet) or
[`mainnet`](/introduction/reference/networks/mainnet).
