...
```js reference
https://github.com/iotaledger/iota.rs/tree/production/bindings/nodejs/examples/05a_get_address_outputs.js
```
...
```js reference
https://github.com/iotaledger/iota.rs/tree/production/bindings/nodejs/examples/05b_get_output.js
```
...
```js reference
https://github.com/iotaledger/iota.rs/tree/production/bindings/nodejs/examples/05c_find_outputs.js
```
