...
Experiment but avoid using it for production applications; opt for [EVM](/wasm-evm/introduction).
:::

:::caution
ISC Smart Contracts are only compatible with the Stardust protocol, deployed on the Shimmer main and testnet.
:::
