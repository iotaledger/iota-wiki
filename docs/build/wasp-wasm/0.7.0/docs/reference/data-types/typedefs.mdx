...
We allow nesting of [container types](../../how-tos/functions-and-events/proxies.mdx#container-proxies), but it
...
In the next section we will explore how the [Schema Tool](../../how-tos/schema-tool/usage.mdx) generates a proxy
interface to mutable [State](../../how-tos/schema-tool/state.mdx).
