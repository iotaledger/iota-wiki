...
WasmLib implements a full set of [value proxies](../../explanations/functions-and-events/proxies.mdx#value-proxies) for each
...
[Params](../../how-tos/functions-and-events/params.mdx) map that was passed into a Func or View, and for the
[Results](../../how-tos/functions-and-events/results.mdx) map that was returned from a call to a Func or View.
