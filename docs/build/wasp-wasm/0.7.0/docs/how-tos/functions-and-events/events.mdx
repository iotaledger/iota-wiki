...
This is why the [Schema Tool](../schema-tool/usage.mdx) allows you to define your own structured events.
The [Schema Tool](../schema-tool/usage.mdx) will generate a structure that will become part of all Func
...
In the next section we will explore how the [Schema Tool](../schema-tool/usage.mdx) helps to simplify
