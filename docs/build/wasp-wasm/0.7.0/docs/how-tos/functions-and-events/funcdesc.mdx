...
The [Schema Tool](../schema-tool/usage.mdx) provides us with an easy way to get access to smart contract
...
The [Schema Tool](../schema-tool/usage.mdx) will generate a specific function descriptor for each func
