...
- Setting up access to [State](state.mdx), [Params](../functions-and-events/params.mdx), and [Results](../functions-and-events/results.mdx) maps
...
that the smart contract uses, the [Funcs](../functions-and-events/funcs.mdx) and [Views](../functions-and-events/views.mdx) that the
contract implements, the [access rights](../functions-and-events/access.mdx) for each function, the
[input parameters](../functions-and-events/params.mdx) and [output results](../functions-and-events/results.mdx) for each function, and
