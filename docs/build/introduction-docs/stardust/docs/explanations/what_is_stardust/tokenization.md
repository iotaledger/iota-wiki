...
some immutable data attached to them. As a consequence, NFTs are supported on base protocol level via _NFT outputs_.
...
explains the recommended way of structuring NFT metadata for future verification and dApp _interoperability_.
