...
To install the IOTA version you need to follow the [Install from source](/wallet.rs/getting_started/python#install-from-source) guide.
...
+ name = "iota-wallet-production"
  ...
  documentation = "/wallet.rs/welcome"
...
Now you can continue the installation from [here](/wallet.rs/getting_started/python#change-to-the-python-binding-directory).
