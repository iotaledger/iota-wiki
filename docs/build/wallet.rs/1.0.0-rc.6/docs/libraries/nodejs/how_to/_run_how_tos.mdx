...
the [example file](https://github.com/iotaledger/wallet.rs/blob/develop/wallet/bindings/nodejs/examples/.env.example) or create a new one with
...
Once you followed the instructions to [build the library](#build-the-library) and installed the dependencies, you will need to select one of the
[Node.js examples](https://github.com/iotaledger/wallet.rs/tree/develop/wallet/bindings/nodejs/examples/). Run the selected example with
...
To run examples, you will need to change to the `wallet/bindings/nodejs/examples` directory, and run any example.
