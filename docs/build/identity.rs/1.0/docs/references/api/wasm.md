...
<dl>
  ...
  <dd>
    <p>
      An extension interface that provides helper functions for publication and
...
NOTE: this does _not_ publish the Alias Output.
...
NOTE: this does _not_ publish the updated Alias Output.
...
- [Proof](#Proof)
  - [new Proof(type\_, properties)](#new_Proof_new)
  - _instance_
...
### new Proof(type\_, properties)

| Param      | Type                |
| ---------- | ------------------- |
| type\_     | <code>string</code> |
...
- [VerificationMethod](#VerificationMethod)
  - _instance_
    ...
    - [.setType(type\_)](#VerificationMethod+setType)
...
### verificationMethod.setType(type\_)
...
| Param  | Type                                   |
| ------ | -------------------------------------- |
| type\_ | [<code>MethodType</code>](#MethodType) |
