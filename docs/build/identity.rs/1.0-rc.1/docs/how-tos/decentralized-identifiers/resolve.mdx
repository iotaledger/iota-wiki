...
IOTA DID Documents according to the read procedure defined in the [IOTA DID Method Specification](../../references/specifications/iota-did-method-spec.md#read).
It fetches the latest [Alias Output](../../references/specifications/iota-did-method-spec.md#alias-output) from the network specified in the DID (see [DID Format](../../references/specifications/iota-did-method-spec.md#did-format)),
