...
Note that the Iota Identity Framework follows [IOTA DID Method Specification](../../references/specifications/iota-did-method-spec.md).
...
since the DID's [Tag](../../references/specifications/iota-did-method-spec.md#iota-tag) contains the
