...
<dl>
  ...
  <dd>
    <p>
      An implementor of <a href='IJwsVerifier'>IJwsVerifier</a> that can handle
      the
...
<dl>
  ...
  <dd>
    ...
    <p>
      This function is useful when one is composing a{' '}
      <a href='IJwsVerifier'>IJwsVerifier</a> that delegates
...
An implementor of [IJwsVerifier](IJwsVerifier) that can handle the
`EdDSA` algorithm.
...
This function is useful when one is composing a [IJwsVerifier](IJwsVerifier) that delegates
