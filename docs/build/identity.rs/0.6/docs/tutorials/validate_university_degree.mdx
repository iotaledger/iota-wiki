...
See [Creating a Decentralized Identity](/identity.rs/how-tos/decentralized-identifiers/create) for more information about generating DIDs.
...
Read more about adding verification methods in [update DID Documents](/identity.rs//how-tos/decentralized-identifiers/update).
...
In order for the issuer to be able to revoke credentials in the future, a revocation list is needed. See [Verifiable Credential Revocation](/identity.rs/how-tos/verifiable-credentials/revocation) for further details.
