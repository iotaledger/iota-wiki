...
A digital signature on a verifiable presentation both provides data _integrity_ and proves the DID of the holder.
...
```rust reference
https://github.com/iotaledger/identity.rs/blob/support/v0.6/examples/account/create_vp.rs
```
