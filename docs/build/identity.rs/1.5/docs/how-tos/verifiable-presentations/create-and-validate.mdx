...
```rust reference
https://github.com/iotaledger/identity.rs/blob/v1.5.0/examples/0_basic/6_create_vp.rs
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.5.0/bindings/wasm/examples/src/0_basic/6_create_vp.ts
```
