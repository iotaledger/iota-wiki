...
```rust reference
https://github.com/iotaledger/identity.rs/blob/v1.4.0/examples/0_basic/0_create_did.rs#L52
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.4.0/bindings/wasm/examples/src/0_basic/0_create_did.ts#L40-L51
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.4.0/examples/0_basic/0_create_did.rs#L59-L71
```
...
```rust reference
https://github.com/iotaledger/identity.rs/blob/v1.4.0/bindings/wasm/examples/src/0_basic/0_create_did.ts#L55C44-L65
```
...
```rust reference
https://github.com/iotaledger/identity.rs/blob/v1.4.0/examples/0_basic/0_create_did.rs#L75
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.4.0/bindings/wasm/examples/src/0_basic/0_create_did.ts#L70
```
...
```rust reference
https://github.com/iotaledger/identity.rs/blob/v1.4.0/examples/0_basic/0_create_did.rs#L78
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.4.0/bindings/wasm/examples/src/0_basic/0_create_did.ts#L74
```
...
```rust reference
https://github.com/iotaledger/identity.rs/blob/v1.4.0/examples/0_basic/0_create_did.rs
```
...
```ts reference
https://github.com/iotaledger/identity.rs/blob/v1.4.0/bindings/wasm/examples/src/0_basic/0_create_did.ts
```
