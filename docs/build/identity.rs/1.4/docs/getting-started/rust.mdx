...
To try out the [examples](https://github.com/iotaledger/identity.rs/tree/v1.2.0/examples), you should:
...
You can find the API reference for the Rust library on [docs.rs](https://docs.rs/identity_iota/latest/identity_iota/index.html).
