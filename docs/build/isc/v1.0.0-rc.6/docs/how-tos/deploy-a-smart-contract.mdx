...
description: 'Learn how to deploy smart contracts to IotaEVM,  Shimmer EVM and EVM Testnet using popular tools like Remix and Hardhat.'
---
...
You can deploy your smart contracts to [IotaEVM](https://iota-evm.blockscout.com/),
[Shimmer EVM](https://explorer.evm.shimmer.network/) and the
[EVM Testnet](https://explorer.evm.testnet.shimmer.network/) using popular tools like [Remix](#remix) and [Hardhat](#hardhat).
