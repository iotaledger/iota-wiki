...
If you want to fund your EVM Testnet account using the [IOTA EVM Toolkit](https://evm-toolkit.evm.iotaledger.net/)
...
2. Once you have added IOTA EVM or ShimmerEVM to Metamask, you can get your address:
...
4. Select IOTA EVM or ShimmerEVM in the network dropdown.

   ![Select the IOTA EVM or ShimmerEVM network](/img/evm/how-tos/get-funds/firefly/select-shimmer-evm.png)
...
3. Bloom will automatically create a IOTA EVM and ShimmerEVM addresses for you, so you can send funds to those addresses from
  the IOTA EVM or Shimmer EVM dropdown. Alternatively, you can input any other IOTA EVM or ShimmerEVM address.
