...
- **[State Map](/schema/how-tos/state):** A repository for all state storage values.
- **[Params Map](/schema/how-tos/params):** Holds the parameter values of the current function call.
- **[Results Map](/schema/how-tos/results):** Returns the result values of the function call.

Through these maps, a complex,
JSON-like data structure can be created with the aid of the [Schema Tool](/schema/how-tos/usage),
...
The [Schema Tool](/schema/how-tos/usage) ensures type-safe code generation, always selecting the suitable proxy type.
