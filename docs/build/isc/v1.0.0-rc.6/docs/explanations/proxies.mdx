...
- **[State Map](../how-tos/wasm/state.mdx):** A repository for all state storage values.
- **[Params Map](../how-tos/wasm/params.mdx):** Holds the parameter values of the current function call.
- **[Results Map](../how-tos/wasm/results.mdx):** Returns the result values of the function call.

Through these maps, a complex,
JSON-like data structure can be created with the aid of the [Schema Tool](../how-tos/wasm/usage.mdx),
...
The [Schema Tool](../how-tos/wasm/usage.mdx) ensures type-safe code generation, always selecting the suitable proxy type.
