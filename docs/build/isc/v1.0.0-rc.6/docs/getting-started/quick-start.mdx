...
Please read [the MetaMask  section in the tools guide](tools.md#metamask) for a detailed guidance.
...
- [Wiki article on configuring wasp-cli](../how-tos/manage-chains/wasp-cli.md)
