---
description: This guide will help you quickly get started with the [EVM Testnet](/build/networks-endpoints/#public-testnet)
...
With this quickstart guide, you should now be able to set up and start exploring the [EVM Testnet](/build/networks-endpoints/#evm-testnet). As you begin to deploy and interact with smart contracts, remember to provide feedback on any issues or improvements you discover to help make the IotaEVM and ShimmerEVM even better. Happy developing!
