...
for IotaEVM, <ChainId url='https://json-rpc.evm.shimmer.network'/>
...
the [EVM Testnet](/build/networks-endpoints/#shimmerevm-testnet):
...
<TabItem value='iotaEVMTestnet' label='IotaEVM Testnet'>
...
whatever you see fit. Click "Save" to add the [EVM Testnet](/build/networks-endpoints/#shimmerevm-testnet) to MetaMask.
