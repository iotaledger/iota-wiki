...
With the introduction of the [Schema Tool](/isc/schema/how-tos/usage), we were able to remove this
...
code that the [Schema Tool](/isc/schema/how-tos/usage) generates when testing our smart contracts. Because
...
then use the `SoloContext` to create a [Function Descriptor](/isc/schema/how-tos/funcdesc) for the wrapped
function, pass any parameters through the its [Params](/isc/schema/how-tos/params) proxy, and then either
[`post()`](/isc/schema/how-tos/post) the function request or [`call()`](/isc/schema/how-tos/call the function. Any
results returned are extracted through the descriptor's [Results](/isc/schema/how-tos/results) proxy, and
...
[`call()`](/isc/schema/how-tos/call) or [`post()`](/isc/schema/how-tos/post the function call through the function
