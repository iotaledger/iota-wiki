...
| Base Token    | Protocol  | Chain ID | RPC URL                              |Websocket RPC URL                     | Explorer                             |
| ------------- | --------- | -------- | ------------------------------------ | ------------------------------------ | ------------------------------------ |
| Shimmer Token | ISC / EVM | 148      | https://json-rpc.evm.shimmer.network | wss://ws.json-rpc.evm.shimmer.network/ |  https://explorer.evm.shimmer.network |
