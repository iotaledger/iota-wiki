---
description: This article sheds light on the transformation from balance models to Unspent Transaction Output (UTXO) models in IOTA, outlining the problems, solutions, and implications of this change.
keywords: [ "IOTA", "UTXO", "Balance Models", "Conflicts", "Reattachments", "Colored Coins" ]
---

## The Switch from Balance Models to UTXO in IOTA
...
However, this simplicity poses some major problems:
