...
This is why IOTA Smart Contracts are not implemented as part of the core protocol but as a layer 2 (L2) protocol to leverages all advantages.
...
- Build on top of [IOTA Smart Contracts](/wasp/overview).
