...
Articles for users belong either to the [Learn](https://wiki.iota.org/docs/learn/about-iota/an-introduction-to-iota) or [Participate](https://wiki.iota.org/docs/participate/support-the-network/about-nodes) spaces. The [Build](https://wiki.iota.org/docs/build/getting-started/architecture) space contains technical explanations on the IOTA technology, as well a subspace for every IOTA product that contains information for its developers and anyone who builds upon IOTA.
