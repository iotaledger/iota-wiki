    ...
    const RenderSlides: () => void = () => {
        return FeaturedSlides.map(slide => (
            <div key={slide.title} className={clsx(styles.slide__container)}>
                <div key={slide.title} className={clsx(styles.slide)} style={
                    {
                        ...
                        <div className={clsx(styles.slide__buttons)}>
                            ...
                            {slide.outlinedButton &&
                                <Link
                                    ...
                                    className={clsx(styles.slide__button, 'button', 'button--outline', 'button--primary')}
                                >
                            ...
                            {slide.solidButton &&
                                <Link
                                    ...
                                    className={clsx(styles.slide__button, 'button', 'button--primary')}
                                >
