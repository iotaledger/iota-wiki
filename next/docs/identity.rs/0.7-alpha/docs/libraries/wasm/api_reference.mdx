...
<dl>
  ...
  <dd>
    <p>
      The result of a key generation in <a href='JwkStorage'>JwkStorage</a>.
    </p>
  </dd>
  <dt>
    <a href='#Jws'>Jws</a>
  ...
  <dd>
    <p>
      A type wrapping a <a href='JwkStorage'>JwkStorage</a> and{' '}
      <a href='KeyIdStorage'>KeyIdStorage</a> that should always be used
      together when working with storage backed DID documents.
    </p>
  </dd>
  <dt>
