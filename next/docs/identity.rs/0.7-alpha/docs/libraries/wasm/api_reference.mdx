...
- [JwtPresentation](#JwtPresentation)
  ...
  - _instance_
    ...
    - [.verifiableCredential()](#JwtPresentation+verifiableCredential) ⇒ [<code>Array.&lt;UnknownCredential&gt;</code>](#UnknownCredential)
...
### jwtPresentation.verifiableCredential() ⇒ [<code>Array.&lt;UnknownCredential&gt;</code>](#UnknownCredential)
...
- [UnknownCredential](#UnknownCredential)
  - _instance_
    ...
    - [.tryIntoRaw()](#UnknownCredential+tryIntoRaw) ⇒ <code>any</code>
...
### unknownCredential.tryIntoRaw() ⇒ <code>any</code>
