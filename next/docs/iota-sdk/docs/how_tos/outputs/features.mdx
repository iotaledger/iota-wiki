...
```rust reference
https://github.com/iotaledger/iota-sdk/tree/develop/sdk/examples/how_tos/outputs/features.rs
```
...
https://github.com/iotaledger/iota-sdk/tree/develop/bindings/nodejs/examples/how_tos/outputs/features.ts
```
...
```python reference
https://github.com/iotaledger/iota-sdk/tree/develop/bindings/python/examples/how_tos/outputs/features.py
```
