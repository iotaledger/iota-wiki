...
You can use the SDK to send transaction with funds that have to be claimed (for example a [micro transaction](send_micro_transaction.mdx)). This How-To will show you how to claim all claimable ouputs in your account.
...
```rust reference
https://github.com/iotaledger/iota-sdk/tree/develop/sdk/examples/how_tos/advanced_transactions/claim_transaction.rs
```
...
https://github.com/iotaledger/iota-sdk/tree/develop/bindings/nodejs/examples/how_tos/advanced_transactions/claim_transaction.ts
```
...
```python reference
https://github.com/iotaledger/iota-sdk/tree/develop/bindings/python/examples/how_tos/advanced_transactions/claim_transaction.py
```
