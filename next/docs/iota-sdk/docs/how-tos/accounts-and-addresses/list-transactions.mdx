...
To get all the transactions you will need to:
...
1. Instantiate a [`Wallet`](https://docs.rs/iota-sdk/latest/iota_sdk/wallet/core/struct.Wallet.html), get Alice's `Account` which was
   [created in the first guide](../accounts-and-addresses/create-account.mdx) and [sync it](../accounts-and-addresses/check-balance.mdx).
2. Get all the [`Transactions`](../../references/nodejs/classes/Transaction/)
   related to the `Account` by calling the
   [`Account.transactions()`](../../references/nodejs/classes/Account/#transactions) function.
...
1. Instantiate a [`Wallet`](https://docs.rs/iota-sdk/latest/iota_sdk/wallet/core/struct.Wallet.html), get Alice's `Account` which was
   [created in the first guide](../accounts-and-addresses/create-account.mdx) and [sync it](../accounts-and-addresses/check-balance.mdx).
2. Get all the [`Transactions`](../../references/python/iota_sdk/types/transaction/)
   related to the `Account` by calling the
