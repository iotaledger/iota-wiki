...
3. Prepare the transaction that will burn the tokens using the [`Account.prepareDestroyFoundry()`](../../references/nodejs/classes/Account/#preparedestroyfoundry)
...
3. Prepare the transaction that will burn the tokens using the [`Account.prepare_destroy_foundry()`](../../references/python/iota_sdk/wallet/account/#prepare_destroy_foundry)
