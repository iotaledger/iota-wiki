...
4. Search the account's balance for a foundry.
5. Display the number of foundries in the balance before destroying.
6. Prepare the transaction that will burn the tokens using the [`Account.prepareDestroyFoundry()`](../../references/nodejs/classes/Account/#preparedestroyfoundry)
   function.
...
4. Search the account's balance for a foundry.
5. Display the number of foundries in the balance before destroying.
6. Prepare the transaction that will burn the tokens using the [`Account.prepare_destroy_foundry()`](../../references/python/iota_sdk/wallet/account/#prepare_destroy_foundry)
   function.
