...
`Account.decrease_native_token_supply(token_id, melt_amount, options)` function.
...
```rust reference
https://github.com/iotaledger/iota-sdk/blob/develop/sdk/examples/how_tos/native_tokens/decrease_supply.rs
```
...
https://github.com/iotaledger/iota-sdk/blob/develop/bindings/nodejs/examples/how_tos/native_tokens/decrease-supply.ts
```
...
```python reference
https://github.com/iotaledger/iota-sdk/blob/develop/bindings/python/examples/how_tos/native_tokens/decrease_supply.py
```
