...
[`unlockConditions`](https://wiki.iota.org/next/iota-sdk/references/nodejs/classes/UnlockCondition/)
by passing them as [output
parameters](https://wiki.iota.org/next/iota-sdk/references/nodejs/interfaces/BasicOutputBuilderParams/#unlockconditions)
when building the outputs:

1. [`StorageDepositReturnUnlockCondition`](https://wiki.iota.org/next/iota-sdk/references/nodejs/classes/StorageDepositReturnUnlockCondition/)
2. [`TimelockUnlockCondition`](https://wiki.iota.org/next/iota-sdk/references/nodejs/classes/TimelockUnlockCondition/)
3. [`ExpirationUnlockCondition`](https://wiki.iota.org/next/iota-sdk/references/nodejs/classes/ExpirationUnlockCondition/)
4. [`GovernorAddressUnlockCondition`](https://wiki.iota.org/next/iota-sdk/references/nodejs/classes/GovernorAddressUnlockCondition/)
5. [`StateControllerAddressUnlockCondition`](https://wiki.iota.org/next/iota-sdk/references/nodejs/classes/StateControllerAddressUnlockCondition/)
6. [`ImmutableAliasAddressUnlockCondition`](https://wiki.iota.org/next/iota-sdk/references/nodejs/classes/ImmutableAliasAddressUnlockCondition/)
...
The following example will add the following
[`unlockConditions`](https://wiki.iota.org/next/iota-sdk/references/python/iota_sdk/client/#parameters-2)
by passing them as [output
parameters](https://wiki.iota.org/next/iota-sdk/references/nodejs/interfaces/BasicOutputBuilderParams/#unlockconditions)
when building the outputs:
