...
You can easily integrate IOTA SDK with your exchange, custody solution, or product.
...
You can import the IOTA SDK and create an account manager using the following example:
