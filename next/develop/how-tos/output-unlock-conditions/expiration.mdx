...
description: 'Discover how to use the Expiration Unlock Condition in Stardust to transfer funds with an expiration deadline, allowing the recipient to claim non-expired funds or the original sender to claim expired funds.'
keywords:
...
The first new _Unlock Condition_ we are going to look at is the [Expiration Unlock Condition](https://wiki.iota.org/shimmer/tips/tips/TIP-0018#expiration-unlock-condition).
