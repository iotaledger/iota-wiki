module.exports = {
  ...
  participate: [
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        'participate/frameworks/introduction',
        'participate/frameworks/streams',
        'participate/frameworks/identity',
        'participate/frameworks/smart-contracts',
        'participate/frameworks/access',
        'participate/frameworks/stronghold',
        'participate/frameworks/oracles',
        {
          type: 'category',
          label: 'Utilities',
          collapsed: true,
          items: [
            'participate/frameworks/utilities/tangle-explorer',
            'participate/frameworks/utilities/visualizer',
            'participate/frameworks/utilities/iota-ipfs',
          ],
        },
      ],
    },
  ...
  build: [
    ...
    },
    {
      ...
      collapsed: true,
      items: ['build/exchange-integration/exchange-integration-guide'],
    },
    {
      type: 'category',
      label: 'Tutorials',
