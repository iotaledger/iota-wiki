          ...
          '@docusaurus/plugin-client-redirects',
          {
            ...
            createRedirects(existingPath) {
              return [
                ...
                existingPath.replace('/shimmer/chronicle','/chronicle/1.0.0-rc.1/',),
                existingPath.replace('/shimmer/cli-wallet', '/cli-wallet/'),
                existingPath.replace('/shimmer/community', '/community/'),
                existingPath.replace('/shimmer/develop/nodes/core-rest-api','/apis/core/v2/',),
                ...
                existingPath.replace('/shimmer/introduction','/introduction/stardust/',),
                ...
                existingPath.replace('/shimmer/smart-contracts/guide/chains_and_nodes','/smart-contracts/guide/chains_and_nodes/',),
                existingPath.replace('/shimmer/smart-contracts/guide/core_concepts','/learn/smart-contracts/core_concepts/',),
                existingPath.replace('/shimmer/smart-contracts/guide/evm/compatibility','/smart-contracts/guide/evm/compatibility/',),
                existingPath.replace('/shimmer/smart-contracts/guide/evm','/smart-contracts/guide/evm/',),
                existingPath.replace('/shimmer/smart-contracts/guide/solo','/smart-contracts/guide/solo/',),
                existingPath.replace('/shimmer/smart-contracts/guide/wasm_vm','/smart-contracts/guide/wasm_vm/',),
                ...
                existingPath.replace('/shimmer/wallet.rs','/wallet.rs/1.0.0-rc.6/',
                ),
              ];
