export const Networks = {
    ...
    shimmer: {
        ...
        evm: {
            ...
            rpcUrls: ['https://json-rpc.evm.shimmer.network', 'wss://ws.json-rpc.evm.shimmer.network'],
    ...
    iota: {
        ...
        evm: {
            ...
            rpcUrls: ['https://json-rpc.evm.iotaledger.net', 'wss://ws.json-rpc.evm.iotaledger.net'],
            blockExplorerUrls: ['https://iota-evm.blockscout.com'],
        },
        evmCustom: {
            chainAddress: 'iota1pzt3mstq6khgc3tl0mwuzk3eqddkryqnpdxmk4nr25re2466uxwm28qqxu5',
            aliasId: '0x971dc160d5ae8c457f7eddc15a39035b6190130b4dbb5663550795575ae19db5'
        }
    }
};
